        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              ...
              <a href="https://www.instagram.com/igifreightsolution" target="_blank" rel="noopener noreferrer" className="h-8 w-8 bg-secondary-slate/20 rounded-full flex items-center justify-center hover:bg-primary-red transition-colors cursor-pointer" aria-label="Instagram">
                 <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
